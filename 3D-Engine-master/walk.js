    ...
    /*
            ...
            */
            ...
            if(surface==='ramp'){
                /*
                OP("in")
                OP(c0p[2]+" "+(c0p[0]+h.c0p))
                OP(c01p[2]+" "+(c01p[0]+h.c01p))
                OP(c1p[2]+" "+(c1p[0]+h.c1p))
                OP(c12p[2]+" "+(c12p[0]+h.c12p))
                OP(c2p[2]+" "+(c2p[0]+h.c2p))
                OP(c23p[2]+" "+(c23p[0]+h.c23p))
                OP(c3p[2]+" "+(c3p[0]+h.c3p))
                OP(c30p[2]+" "+(c30p[0]+h.c30p))
                context.beginPath();
                */
                context.moveTo(c0p[2],c0p[0]+h.c0p);
                context.lineTo(c01p[2],c01p[0]+h.c01p); 
...
/*
    function htmlInfo(){
        var resInfo = document.querySelector('#canRes');

        var newP = document.createElement('p');
        var scoreText = document.createTextNode("Good job! You made it to class with time to spare and learned a lot about the DOM (Which was used to display this text and the table below). Your time was "+timerDisp.innerHTML+".");
        newP.appendChild(scoreText)
        resInfo.appendChild(newP)

        var newh1 = document.createElement('h1');
        resInfo.appendChild(newh1)
        var headingTxt = document.createTextNode("O'Rahilly Maze Comparisons");
        newh1.appendChild(headingTxt)

        var newPCount = document.createElement('p');
        resInfo.appendChild(newPCount)
        var countTxt = document.createTextNode("The following data is compiled from "+res[0]+" randomly generated mazes and updates each time someone finishes a game.");
        newPCount.appendChild(countTxt)

        var newP2 = document.createElement('p');
        resInfo.appendChild(newP2)
        var htTable = document.createElement('table');
        newP2.appendChild(htTable)

        var htRow1 = document.createElement('tr');
        htTable.appendChild(htRow1)

        var htRow1H1=document.createElement('th');
        htRow1.appendChild(htRow1H1)

        var htRow1H2=document.createElement('th');
        htRow1.appendChild(htRow1H2)
        var htRow1H2Txt = document.createTextNode("Spaces");
        htRow1H2.appendChild(htRow1H2Txt)

        var htRow1H3=document.createElement('th');
        htRow1.appendChild(htRow1H3)
        var htRow1H3Txt = document.createTextNode("Junctions");
        htRow1H3.appendChild(htRow1H3Txt)


        var htRow2 = document.createElement('tr');
        htTable.appendChild(htRow2)

        var htRow2H1=document.createElement('th');
        htRow2.appendChild(htRow2H1)
        var htRow2H1Txt = document.createTextNode("Minimum");
        htRow2H1.appendChild(htRow2H1Txt)

        var htRow2H2=document.createElement('td');
        htRow2.appendChild(htRow2H2)
        var htRow2H2Txt = document.createTextNode(res[3]);
        htRow2H2.appendChild(htRow2H2Txt)

        var htRow2H3=document.createElement('td');
        htRow2.appendChild(htRow2H3)
        var htRow2H3Txt = document.createTextNode(res[5]);
        htRow2H3.appendChild(htRow2H3Txt)





        var htRow3 = document.createElement('tr');
        htTable.appendChild(htRow3)

        var htRow3H1=document.createElement('th');
        htRow3.appendChild(htRow3H1)
        var htRow3H1Txt = document.createTextNode("Average");
        htRow3H1.appendChild(htRow3H1Txt)

        var htRow3H2=document.createElement('td');
        htRow3.appendChild(htRow3H2)
        var htRow3H2Txt = document.createTextNode(res[1]);
        htRow3H2.appendChild(htRow3H2Txt)

        var htRow3H3=document.createElement('td');
        htRow3.appendChild(htRow3H3)
        var htRow3H3Txt = document.createTextNode(res[2]);
        htRow3H3.appendChild(htRow3H3Txt)




        var htRow4 = document.createElement('tr');
        htTable.appendChild(htRow4)

        var htRow4H1=document.createElement('th');
        htRow4.appendChild(htRow4H1)
        var htRow4H1Txt = document.createTextNode("Maximum");
        htRow4H1.appendChild(htRow4H1Txt)

        var htRow4H2=document.createElement('td');
        htRow4.appendChild(htRow4H2)
        var htRow4H2Txt = document.createTextNode(res[4]);
        htRow4H2.appendChild(htRow4H2Txt)

        var htRow4H3=document.createElement('td');
        htRow4.appendChild(htRow4H3)
        var htRow4H3Txt = document.createTextNode(res[6]);
        htRow4H3.appendChild(htRow4H3Txt)


        var htRow5 = document.createElement('tr');
        htTable.appendChild(htRow5)

        var htRow5H1=document.createElement('th');
        htRow5.appendChild(htRow5H1)
        var htRow5H1Txt = document.createTextNode("Your Maze");
        htRow5H1.appendChild(htRow5H1Txt)

        var htRow5H2=document.createElement('td');
        htRow5.appendChild(htRow5H2)
        var htRow5H2Txt = document.createTextNode(totalSpaces);
        htRow5H2.appendChild(htRow5H2Txt)

        var htRow5H3=document.createElement('td');
        htRow5.appendChild(htRow5H3)
        var htRow5H3Txt = document.createTextNode(totalTurns);
        htRow5H3.appendChild(htRow5H3Txt)

        resInfo.style.textAlign='center';
        resInfo.style.marginTop='0';
        resInfo.style.marginBottom='auto';
        resInfo.style.marginLeft='15%';
        resInfo.style.marginRight='15%';

        htTable.style.marginLeft='auto';
        htTable.style.marginRight='auto';


        var smile = document.createElement("IMG");
        smile.setAttribute("src", "messages/smile.jpg");
        smile.setAttribute("alt", "Thanks for playing!");
        smile.setAttribute("alt", "Smile");
        resInfo.appendChild(smile);
...
*/
    ...
    function htmlInfo(){
        ...
        var newP = document.createElement('p');
        var scoreText = document.createTextNode("Good job! You made it to class with time to spare and learned a lot about the DOM (Which was used to display this text). Your time was "+timerDisp.innerHTML+".");
        newP.appendChild(scoreText)
        resInfo.appendChild(newP)
        ...
        var smile = document.createElement("IMG");
        smile.className = "smileClass";
        smile.setAttribute("src", "messages/smile.jpg");
        smile.setAttribute("alt", "Thanks for playing!");
        smile.setAttribute("alt", "Smile");
        resInfo.appendChild(smile);

        smileClass.style.marginTop='2px';
